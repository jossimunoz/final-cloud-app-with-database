...
def submit(request, course_id):
    ...
    for choice_id in extract_answers(request):
        ...
        submission.choices.add(choice_instance)
...
def show_exam_result(request, course_id, submission_id):
    ...
    context['choices_ids'] = choices_ids
    ...
    for question in context['questions']:
        i+=1
        score = question.is_get_score(choices_ids);
        question_data = {
            'question': question,
            'has_score': score
        }
        questions_with_scores.append(question_data)
    ...
    print(i)
    print(s)
    context['questions_with_scores'] = questions_with_scores
    context['course'] = course

    context['grade'] =  int(s/i*100)
